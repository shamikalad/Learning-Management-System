  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <!-- New Enquiry Menu -->
    <li class="nav-item">
      <a class="nav-link collapsed" href="EnquiryDataTable.jsp">
        <i class="bi bi-question-square"></i><span>Enquiry</span>
      </a>
    </li><!-- End Enquiry Nav -->
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="AdminRegistration.jsp">
              <i class="bi bi-circle"></i><span>Admin Registration</span>
            </a>
          </li>
          <li>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="ClientRegistration.jsp">
               <i class="bx bxs-id-card"></i><span>Client Registration</span>
            </a>
          </li>
          <li>
            <a href="ClientDataTable.jsp">
              <i class="bi bi-circle"></i><span>Client Data</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Course</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Project</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="ProjectDataTable.jsp">
              <i class="bi bi-circle"></i><span>Project Data</span>
            </a>
          </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#fees-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-cash"></i><span>Fees</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="fees-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="Fees.jsp">
            <i class="bi bi-circle"></i><span>Add Fees</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class="bi bi-circle"></i><span>Fees Data</span>
          </a>
        </li>
      </ul>
    </li><!-- End Fees Nav -->
